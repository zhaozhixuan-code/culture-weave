package com.zzx.cultureweavebackend.aop;
...
public class AuthInterceptor {
     ...
     * 切点
     */
    @Pointcut("execution(* com.zzx.cultureweavebackend.controller.*.*(..)) &&  @annotation(com.zzx.cultureweavebackend.annotation.AuthCheck)")
